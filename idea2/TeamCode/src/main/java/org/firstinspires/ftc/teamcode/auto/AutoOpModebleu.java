...
import org.firstinspires.ftc.teamcode.robot.CarouselBlue;
import org.firstinspires.ftc.teamcode.robot.Movement2;

@Autonomous(name="AutoOpMode Linear Bleu")
public class AutoOpModebleu extends LinearOpMode {

    private ElapsedTime runtime = new ElapsedTime();
    private Movement2 movement;
    private CarouselBlue carouselBlue;
    private Arm arm;
    ...
    public void runOpMode() {
        ...
        carouselBlue = new CarouselBlue(telemetry, runtime, hardwareMap);
