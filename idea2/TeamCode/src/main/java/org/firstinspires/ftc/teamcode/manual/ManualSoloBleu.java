...
@TeleOp(name="Manual Solo Bleu")
public class ManualSoloBleu extends OpMode {
    ...
    public void init() {
        ...
        carousel = new CarouselBlue(telemetry, runtime, hardwareMap);
